...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, tr.com.aurora.arge.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, tr.com.aurora.arge.repository.UserRepository.USERS_BY_EMAIL_CACHE);
